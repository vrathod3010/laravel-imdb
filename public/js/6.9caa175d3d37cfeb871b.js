  ...
  computed: {
    heroImageStyle: function heroImageStyle() {
      ...
      if (this.movie.images.backdrops.length > 0) {
        ...
        return 'background: url("' + "https://image.tmdb.org/t/p/original/" + this.movie.images.backdrops.sample().file_path + '");';
      }
    },
...
var render = function() {
  ...
  return _c("layout", [
    _c("div", { staticClass: "movie-info border-b border-gray-700" }, [
      _c("div", {
        staticClass: "hero-image h-80  shadow-inner",
      ...
      _c(
        ...
        {
          staticClass:
            "container mx-auto px-4 pt-16 pb-8 items-center md:items-start flex flex-col lg:flex-row"
        },
        [
          _c("img", {
            staticClass: "w-96 transform -translate-y-40 ",
            attrs: {
              src:
          ...
          _c(
            ...
            {
              staticClass:
                "mt-12 lg:mt-0 lg:ml-24 transform -translate-y-20 md:-translate-y-0"
            },
            [
