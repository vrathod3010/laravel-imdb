  ...
  computed: {
    heroImageStyle: function heroImageStyle() {
      ...
      if (this.movie.images.backdrops.length > 0) {
        return 'background: url("' + "https://image.tmdb.org/t/p/original/" + this.movie.images.backdrops.sample().file_path + '"),rgba(74, 74, 74, 0.5)' + "";
      } else {
  ...
  return _c("layout", [
    _c("div", { staticClass: "movie-info border-b border-gray-700" }, [
      _c(
        "div",
        {
          staticClass: "hidden lg:block hero-image h-80  shadow-inner relative",
